...
class LocationDetailContent extends StatefulWidget {
  ...
  final String name;
  @override
  _LocationDetailContentState createState() => _LocationDetailContentState();
}

class _LocationDetailContentState extends State<LocationDetailContent> {
  @override
  void setState(fn) {
    if (mounted) {
      super.setState(fn);
